...
export function TradingChart({
    ...
    // Refs to hold series instances so we can update data without recreating the chart
    ...
    useEffect(() => {
        ...
        // Optimization: `candles` is removed from dependencies to avoid destroying chart on data update
